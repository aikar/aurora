...
function getProject() {
  ...
  var projectjson;
  try {
  	projectjson = fs.readFileSync(base + "/aurora.json").toString();
  } catch (e) {
  	if (process.argv.length >= 3) {
		projectjson = '{}';
	} else {
		e.message = "Could not read aurora.json: " + e.message;
		throw e;
	}
  }
  ...
  try {
    ...
    e.message = "Error parsing aurora.json: " + e.message;
    throw e;
  }
